...
```json
{
  ...
  "amount": число,
  "category": "продукты" | "рестораны" | "такси" | "образование" | "путешествия" | "развлечения" | "здоровье" | "электроника" | "зарплата" | "другое",
  "description": "краткое описание"
}
```

Примеры категорий:
- продукты: еда, напитки из магазина
- рестораны: кафе, рестораны, доставка еды
- такси: транспорт, uber, яндекс такси
- образование: курсы, книги, обучение
- путешествия: билеты, отели
- развлечения: кино, игры, хобби
- здоровье: медицина, аптека, спорт
- электроника: техника, гаджеты, телефоны
- зарплата: для доходов
- другое: всё остальное

После JSON добавь дружелюбное подтверждение для пользователя типа "✅ Записал расход 2500₽ на продукты!".
...
**Категории:**
продукты, рестораны, такси, образование, путешествия, развлечения, здоровье, электроника, зарплата, другое

Просто общайся со мной естественным языком! 💬"""
