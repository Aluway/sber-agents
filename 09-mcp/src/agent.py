...
async def create_bank_agent():
    ...
    # Подключаем MCP инструменты (search_products, currency_converter, find_optimal_deposit)
    if config.MCP_ENABLED:
        try:
            ...
            logger.warning("   Agent will work without MCP tools (search_products, currency_converter, find_optimal_deposit)")
